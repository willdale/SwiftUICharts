...
struct DataFunctions {
    ...
    static func dataSetMaxValue<T:DataSet>(from dataSets: [T]) -> Double {
    ...
    static func dataSetMinValue<T:DataSet>(from dataSets: [T]) -> Double {
        var setHolder : [Double] = []
        for set in dataSets {
    ...
    static func dataSetAverage<T:DataSet>(from dataSets: [T]) -> Double {
        var setHolder : [Double] = []
        for set in dataSets {
    ...
    static func dataSetRange<T:DataSet>(from dataSets: [T]) -> Double {
